...
namespace PBL3.Migrations
{
    ...
    [Migration("20230502090631_ModifyBook")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PBL3.Models.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AccountAccName")
                        .IsRequired()
                        .HasColumnType("varchar(50)");

                    b.Property<string>("TitleIdTitle")
                        .IsRequired()
                        .HasColumnType("varchar(50)");

                    b.HasKey("Id");

                    b.HasIndex("AccountAccName");

                    b.HasIndex("TitleIdTitle");
            ...
            modelBuilder.Entity("PBL3.Models.Entities.Cart", b =>
                {
                    b.HasOne("PBL3.Models.Entities.Account", "Account")
                        .WithMany("Carts")
                        .HasForeignKey("AccountAccName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PBL3.Models.Entities.Title", "Title")
                        .WithMany("Carts")
                        .HasForeignKey("TitleIdTitle")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
